    ...
    return (
        <>
            <Breadcrumb>
                ...
                <Breadcrumb.Item href={`/admin/pengawasan/usaha/${lingkupPengawasan.id}`}>Pilih Objek Pengawasan</Breadcrumb.Item>
                <Breadcrumb.Item active>{`${jenisRantaiPasok.pelakuUsaha} Rantai Pasok ${jenisRantaiPasok.kategoriSumberDaya} Konstruksi`}</Breadcrumb.Item>
            </Breadcrumb>
...
PengawasanUsahaRantaiPasokIndex.layout = page => <Layout children={page} />;

export default PengawasanUsahaRantaiPasokIndex;
