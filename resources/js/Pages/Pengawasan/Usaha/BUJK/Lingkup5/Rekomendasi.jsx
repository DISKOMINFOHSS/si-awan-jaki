...
const RekomendasiPengawasanBUJKLingkup5 = ({ data }) => {
    console.log(data);
...
RekomendasiPengawasanBUJKLingkup5.layout = page => <Layout children={page} />;

export default RekomendasiPengawasanBUJKLingkup5;
