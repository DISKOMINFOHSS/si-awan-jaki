    ...
    return (
        <>
            <Breadcrumb>
                ...
                <Breadcrumb.Item href={`/admin/pendataan/usaha/`}>Usaha Rantai Pasok</Breadcrumb.Item>
            ...
            <div className="flex justify-between items-center my-2">
                <div>
                    ...
                    <h2 className="text-xs text-slate-700">{usaha.jenisUsaha.pelakuUsaha} Rantai Pasok {usaha.jenisUsaha.kategoriSumberDaya} Konstruksi</h2>
                </div>
