...
export default ({
    ...
    function handleSubmit(e) {
        e.preventDefault();
        console.log(data);
        post(`/admin/pengawasan/usaha/bujk/rutin`, {
            onSuccess: () => {
                onClose();
                reset();
            },
            ...
            >
                <Modal.Header onClose={onClose}>
                    <div className="text-center mb-7">
                        ...
                        <h2 className="text-xs text-slate-500 font-light">Badan Usaha Jasa Konstruksi</h2>
                    </div>
                </Modal.Header>
                <Modal.Body>
                        ...
                        <div className="space-y-2 text-xs">
                            ...
                            <div className="grid grid-cols-2 h-9 items-center">
                                <div className="flex items-start gap-x-1.5">
                                    <input
                                        type="radio" id="true-statusNIB" name="statusNIB" value={true} onChange={e => setData('statusNIB', e.target.value === "true")}
                                ...
                                <div className="flex items-start gap-x-1.5">
                                    <input
                                        type="radio" id="false-statusNIB" name="statusNIB" value={false} onChange={e => setData('statusNIB', e.target.value === "true")}
                                        className="w-3.5 h-3.5 text-blue-600 border-slate-200 focus:ring-blue-500 focus:ring-2"
                                    />
