                    ...
                    <table className="w-full text-xs">
                        <thead className="bg-slate-50 border-b border-slate-100 text-slate-500 uppercase">
                            <tr className="border-b border-slate-200">
                                ...
                                <th scope="col" className="p-4 font-medium min-w-40 border-r border-slate-200">Tanggal Pengawasan</th>
                                <th scope="col" className="p-4 font-medium border-r border-slate-200">Pelaksanaan Pengembangan <br /> Usaha Berkelanjutan</th>
                                <th></th>
                            </tr>
                        </thead>
                            ...
                            <tr key={pengawasan.id} className="border-b border-slate-100 hover:bg-slate-50">
                                ...
                                <td className="px-4 py-5">
                                    <div className="flex justify-end gap-x-2">
                                        <Link
                                            href={`/admin/pengawasan/usaha/5/${pengawasan.id}`}
