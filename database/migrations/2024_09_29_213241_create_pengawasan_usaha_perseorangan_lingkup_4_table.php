...
return new class extends Migration
{
    ...
    {
        Schema::create('pengawasan_usaha_perseorangan_lingkup_4', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->string('jenis_pengawasan');
            $table->date('tanggal_pengawasan');
            $table->foreignUuid('usaha_id');

            $table->boolean('tertib_persyaratan_skk')->nullable();
    ...
    {
        Schema::dropIfExists('pengawasan_usaha_perseorangan_lingkup_4');
    }
};
