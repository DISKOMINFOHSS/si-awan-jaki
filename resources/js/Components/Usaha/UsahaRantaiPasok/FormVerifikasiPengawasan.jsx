...
export default ({
    ...
    const [ values, setValues ] = React.useState({
        tertibPerizinanBerusaha: tertibPerizinanBerusaha,
        tertibPerizinanPenggunaan: tertibPerizinanPenggunaan,
        tertibPencatatanSIMPK: tertibPencatatanSIMPK,
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-x-4 gap-y-1.5 border-b border-slate-100 pb-4">
                            <div className="space-y-2 text-xs">
                                <div>
                                    <div className="text-slate-800">Perizinan Berusaha <span className="text-red-400">*</span></div>
                                    {/* <div className="font-light text-[11px] text-slate-500">Kesesuaian Kegiatan Konstruksi</div> */}
                                </div>
                                <InputRadio
                                    id="tertibPerizinanBerusaha"
                                    isTrue={values.tertibPerizinanBerusaha}
                            ...
                            <div className="space-y-2 text-xs">
                                <div>
                                    <div className="text-slate-800">Perizinan Penggunaan Bahan Baku <span className="text-red-400">*</span></div>
                                    {/* <div className="font-light text-[11px] text-slate-500">Kesesuaian Kegiatan Konstruksi</div> */}
                                </div>
                                <InputRadio
                                    id="tertibPerizinanPenggunaan"
                                    isTrue={values.tertibPerizinanPenggunaan}
                                    onInputChange={handleInputChange}
                                    label="Tertib"
                                />
                            </div>
                        ...
                        <div className="grid grid-cols-2 gap-x-4 gap-y-1.5 border-b border-slate-100 pb-4">
                            <div className="space-y-2 text-xs">
                                <div>
                                    <div className="text-slate-800">Pencatatan dalam SIMPK <span className="text-red-400">*</span></div>
                                    {/* <div className="font-light text-[11px] text-slate-500">Kesesuaian Kegiatan Konstruksi</div> */}
                                </div>
                                <InputRadio
                                    id="tertibPencatatanSIMPK"
                                    isTrue={values.tertibPencatatanSIMPK}
                                    onInputChange={handleInputChange}
                                    label="Tertib"
                                />
                            </div>
