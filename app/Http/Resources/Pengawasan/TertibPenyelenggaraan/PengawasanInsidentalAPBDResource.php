...
use App\Http\Resources\Pengawasan\TertibPenyelenggaraan\LingkupPengawasanInsidentalAPBDResource;
use Illuminate\Http\Request;
use Illuminate\Http\Resources\Json\JsonResource;

class PengawasanInsidentalAPBDResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'daftarLingkupPengawasan'            => LingkupPengawasanInsidentalAPBDResource::collection($this->whenHas('daftar_lingkup_pengawasan')),
