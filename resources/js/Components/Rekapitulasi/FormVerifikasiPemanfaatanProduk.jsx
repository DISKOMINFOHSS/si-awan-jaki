...
import { LiaCitySolid, LiaMapMarkerAltSolid } from "react-icons/lia";
...
export default ({ isVisible, onClose, bangunan }) => {
    ...
    console.log(daftarPengawasan);

    // const daftarPengawasanRutin = pengawasan.filter(({jenis_pengawasan}) => jenis_pengawasan === 'Rutin');
    // const daftarPengawasanInsidental = pengawasan.filter(({jenis_pengawasan}) => jenis_pengawasan === 'Insidental');
