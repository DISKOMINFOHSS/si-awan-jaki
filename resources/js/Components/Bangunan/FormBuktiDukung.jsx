...
export default ({
    ...
    React.useEffect(() => {
        setData({
            ...data,
            id: buktiDukung.id,
            tahun: getDefaultData(buktiDukung.tahun, 2024),
            label: getDefaultData(buktiDukung.label),
            url: getDefaultData(buktiDukung.url),
        });
    }, [buktiDukung]);
    ...
    function handleSubmit(e) {
        e.preventDefault();
        console.log(data);
        post(`/admin/pendataan/bangunan/${bangunanId}/bukti-dukung`, {
            onSuccess: () => {
                onClose();
            },
            onError: (errors) => {
        ...
        <>
            <Modal isVisible={isVisible} className="w-full max-w-lg h-fit mt-10">
                <Modal.Header onClose={onClose}>
                    <div className="text-center mb-7">
                        <h1 className="font-medium text-slate-800">{buktiDukung.id ? "Edit" : "Tambah"} Bukti Dukung</h1>
                        <h2 className="text-xs text-slate-500 font-light">Pendataan Bangunan Konstruksi</h2>
                    </div>
                </Modal.Header>
                <Modal.Body>
                    <form
                    ...
                    >
                        ...
                        <div className="col-span-2">
                            ...
                            <input
                                type="text" name="label" id="label" placeholder="cth. Laporan Kegiatan Pemanfaatan Produk"
                        ...
                        <div className="col-span-3 space-y-2.5">
                            <label htmlFor="url" className="space-y-0.5 text-xs">
                                <div className="font-medium text-slate-800">Link Folder Bukti Dukung <span className="text-red-400">*</span></div>
            ...
            >
                ...
                <div className="font-light text-xs text-slate-500 mb-2">
                    Gagal menambahkan bukti dukung. Silakan periksa kembali informasi yang diisi.
                </div>
            </ModalError>
        </>
    )
