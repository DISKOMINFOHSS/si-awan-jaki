        ...
        return $this->collection->transform(
            function ($proyek)
            {
                return [
                    ...
                    'tertibProsesPemilihanPenyediaJasa'  => $proyek->tertib_proses_pemilihan_penyedia_jasa === null ?
                        $proyek->tertib_proses_pemilihan_penyedia_jasa : (bool)$proyek->tertib_proses_pemilihan_penyedia_jasa,
                    'tertibPenerapanStandarKontrak'      => $proyek->tertib_penerapan_standar_kontrak === null ?
                        $proyek->tertib_penerapan_standar_kontrak : (bool)$proyek->tertib_penerapan_standar_kontrak,
                    'tertibPenggunaanTKK'                => $proyek->tertib_penggunaan_tkk === null ?
                        $proyek->tertib_penggunaan_tkk : (bool)$proyek->tertib_penggunaan_tkk,
                    'tertibPemberianPekerjaan'           => $proyek->tertib_pemberian_pekerjaan === null ?
                        $proyek->tertib_pemberian_pekerjaan : (bool)$proyek->tertib_pemberian_pekerjaan,
                    'tertibKetersediaanDokumenStandarK4' => $proyek->tertib_ketersediaan_dokumen_standar_k4 === null ?
                        $proyek->tertib_ketersediaan_dokumen_standar_k4 : (bool)$proyek->tertib_ketersediaan_dokumen_standar_k4,
                    'tertibPenerapanSMKK'                => $proyek->tertib_penerapan_smkk === null ?
                        $proyek->tertib_penerapan_smkk : (bool)$proyek->tertib_penerapan_smkk,
