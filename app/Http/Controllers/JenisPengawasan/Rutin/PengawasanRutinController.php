...
class PengawasanRutinController extends Controller
{
    ...
    {
        $daftarTertibPenyelenggaraan = $this->rekapTertibPenyelenggaraanService->getDaftarPengawasanByJenisPengawasan($tahun, 'Rutin');
        ...
        return Inertia::render('JenisPengawasan/Rutin/TertibPenyelenggaraan/Index', [
            'data' => [
                'daftarTertibPenyelenggaraan' => PengawasanPenyelenggaraanAPBDResource::collection($daftarTertibPenyelenggaraan),
                'totalTertibPengawasan' => [
                    'tertibUsaha'             => [
    ...
    {
        $daftarTertibPemanfaatan = $this->rekapTertibPemanfaatanProdukService->getDaftarPengawasanByJenisPengawasan($tahun, 'Rutin');
        ...
        return Inertia::render('JenisPengawasan/Rutin/TertibPemanfaatanProduk/Index', [
            'data' => [
                'daftarTertibPemanfaatanProduk' => PengawasanPemanfaatanProdukResource::collection($daftarTertibPemanfaatan),
                'totalTertibPengawasan'         => [
                    'tertibUsaha'             => [
